 ...
 * @author LIMON
 */
public class Page_82_A_Update_Timeslot_Controller implements Initializable {
    ...
    private void searchButtonHandler(ActionEvent event) {
        ...
        dayChoiceBox.setValue(t.getDay());
    ...
    private void updateButtonHandler(ActionEvent event) throws IOException {
        ...
        t.setId(id);
        t.setDay(day);
        t.setStartTime(LocalTime.of(startHour, startMin));
        t.setEndTime(LocalTime.of(endHour, endMin));
